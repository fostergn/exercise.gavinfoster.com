...
export function postAddRequest() {
  return {
...
export function receiveAddResponse(response) {
  return function receiveAddResponseDispatch(dispatch) {
...
export function addContact(contact) {
  return function addContactDispatch(dispatch) {
...
export function fetchContacts() {
  return function fetchContactsDispatch(dispatch) {
...
export function updateContact(contact) {
  return function updateContactDispatch(dispatch) {
...
export function receiveDeleteResponse(response) {
  ...
  return function receiveDeleteResponseDispatch(dispatch) {
    dispatch(receiveDeleteContact(response));
  };
}

export function deleteContact(id) {
  return function deleteContactDispatch(dispatch) {
